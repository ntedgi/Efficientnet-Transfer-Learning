...
def EfficientNetB0(include_top=True,
    ...
    return EfficientNet(1.0, 1.0, 224, 0.2,
                        model_name='efficientnet_lib-b0',
...
def EfficientNetB1(include_top=True,
    ...
    return EfficientNet(1.0, 1.1, 240, 0.2,
                        model_name='efficientnet_lib-b1',
                        include_top=include_top, weights=weights,
                        input_tensor=input_tensor, input_shape=input_shape,
                        pooling=pooling, classes=classes,
                        **kwargs)
...
def EfficientNetB2(include_top=True,
    ...
    return EfficientNet(1.1, 1.2, 260, 0.3,
                        model_name='efficientnet_lib-b2',
                        include_top=include_top, weights=weights,
                        input_tensor=input_tensor, input_shape=input_shape,
                        pooling=pooling, classes=classes,
                        **kwargs)
...
def EfficientNetB3(include_top=True,
    ...
    return EfficientNet(1.2, 1.4, 300, 0.3,
                        model_name='efficientnet_lib-b3',
                        include_top=include_top, weights=weights,
                        input_tensor=input_tensor, input_shape=input_shape,
                        pooling=pooling, classes=classes,
                        **kwargs)
...
def EfficientNetB4(include_top=True,
    ...
    return EfficientNet(1.4, 1.8, 380, 0.4,
                        model_name='efficientnet_lib-b4',
                        include_top=include_top, weights=weights,
                        input_tensor=input_tensor, input_shape=input_shape,
                        pooling=pooling, classes=classes,
                        **kwargs)
...
def EfficientNetB5(include_top=True,
    ...
    return EfficientNet(1.6, 2.2, 456, 0.4,
                        model_name='efficientnet_lib-b5',
                        include_top=include_top, weights=weights,
                        input_tensor=input_tensor, input_shape=input_shape,
                        pooling=pooling, classes=classes,
                        **kwargs)
...
def EfficientNetB6(include_top=True,
    ...
    return EfficientNet(1.8, 2.6, 528, 0.5,
                        model_name='efficientnet_lib-b6',
                        include_top=include_top, weights=weights,
                        input_tensor=input_tensor, input_shape=input_shape,
                        pooling=pooling, classes=classes,
                        **kwargs)
...
def EfficientNetB7(include_top=True,
    ...
    return EfficientNet(2.0, 3.1, 600, 0.5,
                        model_name='efficientnet_lib-b7',
                        include_top=include_top, weights=weights,
                        input_tensor=input_tensor, input_shape=input_shape,
                        pooling=pooling, classes=classes,
                        **kwargs)
